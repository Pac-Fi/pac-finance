...
export const WRAPPED_NATIVE_TOKEN_PER_NETWORK: { [network: string]: string } = {
  ...
  [eParallelNetwork.devL2]: "0x1E48dfD798560Ba47cb061fd6531C0bEa97C9459",
  [eParallelNetwork.mainnet]: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2",
...
export const chainlinkAggregatorProxy: Record<string, string> = {
  ...
  [eParallelNetwork.devL2]: "0x1019Be98D5f2A566179d5AF32bcdeE30e11A72C6",
